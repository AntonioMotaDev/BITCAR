                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="year" id="year" value="{{ old('year', date('Y')) }}" min="1900" max="{{ date('Y') + 1 }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="type" id="type" 
                                ...
                                <option value="sedan" {{ old('type') == 'sedan' ? 'selected' : '' }}>Sedán</option>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="mileage" id="mileage" value="{{ old('mileage', 0) }}" min="0" step="0.01"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="fuel_capacity" id="fuel_capacity" value="{{ old('fuel_capacity') }}" min="0" step="0.01"
